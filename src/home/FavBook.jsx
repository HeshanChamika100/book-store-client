...
const FavBook = () => {
  return (
    <div className="px-4 lg:px-24 my-20 flex md:flow-row justify-between items-center gap-12">
      ...
      <div className="md:w-1/2">
        ...
        <p className="mb-10 text-lg md:w-5/6 space-x-6">
          Lorem, ipsum dolor sit amet consectetur adipisicing elit. Deserunt
          vel, tenetur et ad sapiente odio fugiat architecto ab fuga quaerat
          vero veniam expedita inventore nostrum omnis nobis ratione excepturi
          sunt.
        </p>
        {/* stats */}
